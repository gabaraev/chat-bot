...
export default function Socials({ theme }: SocialsProps) {
    ...
    return (
        <div className="social-wrapper">
            <a href='http://vk.com/sfedu_official' target="_blank"><img src={`icons/vk-${theme}.svg`} alt='вконтакте' /></a>
            ...
            <a href='https://t.me/sfedu_study' target="_blank"><img src={`icons/telegram-${theme}.svg`} alt="телеграмм" /></a>
